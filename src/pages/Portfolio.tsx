...
const Portfolio = () => {
  const freelancers = [
    ...
    // },
    {
      id: 4,
      name: "art_beast",
      title: "Professional Graphic and Web Designer",
      // location: "Seattle, WA",
      rating: 4.8,
      reviews: 46,
      hourlyRate: 30,
      avatar: "https://legiit-user.s3.amazonaws.com/7bd15a6d58dc74207f89ce919ff52782/96b637f0468d641793d99022e505b267.png",
      skills: ["Software Engineer", "Web Development", "UI/UX Design", "Graphic Design"],
